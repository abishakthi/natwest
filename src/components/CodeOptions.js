...
const CodeOptions = ({ className = "" }) => {
  ...
  const toggleTheme = () => {
    ...
    // Apply the theme change to the diagram
    if (diagramRef.current) {
      diagramRef.current.classList.toggle("dark-theme", isDarkTheme);
    }
  };

  const saveAsPNG = () => {
    // Logic to save the diagram as PNG
    console.log("Save as PNG");
  };

  const saveAsPDF = () => {
    // Logic to save the diagram as PDF
    console.log("Save as PDF");
  };

  return (
    <div className={`code-options ${className}`}>
      <div className="frame-parent">
        <div className="diagram-wrapper">
          <a className="diagram">Diagram</a>
        </div>
        <div className="full-screen-option-parent">
          <div className="full-screen-option">
          <label id="theme-toggle-button">
  <input type="checkbox" id="toggle" checked={isDarkTheme}
    ...
    <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
      ...
      <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars">
        ...
        <path transform="translate(2.218 14.616) rotate(169)" d="M1.261,0,.774.571.114.3.487.967,0,1.538.728,1.32l.372.662.047-.749.728-.218L1.215.749Z" data-name="star"></path>
          ...
          <div className="full-screen-option1">
  ...
  <span class="tooltip">Fullscreen</span>
      ...
      <div className="frame" ref={diagramRef}>
        {/* Diagram will be displayed here */}
      </div>
      <div className="frame-group">
        <div className="frame1">
        <button onClick={saveAsPNG} class="Download-button">
  <svg
  ...
  <span>Image</span>
        ...
        <button onClick={saveAsPDF} class="Download-button">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="16"
    width="20"
